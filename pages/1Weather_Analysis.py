...
def fallback_city_lookup(city_name):
    ...
    # City not found
    st.error(f" fCity '{city_name}' not found in database.")
    st.info("""
...
if 'current_weather' in st.session_state and 'forecast_data' in st.session_state:
    ...
    weather_desc = get_weather_description(current_data['weather_code'])
    ...
    if df_forecast is not None and not df_forecast.empty:
        ...
        fig_conditions = px.bar(
            ...
            labels={'Condition': 'Weather Condition', 'Count': 'Number of Hours'},
            color='Count',
        ...
        with col1:
            ...
            **Temperature Analysis:**
            ...
            - {"Expect warm conditions ️" if avg_temp > 25 else "Expect mild conditions ️" if avg_temp > 15 else "Expect cool conditions️"}
            """)
