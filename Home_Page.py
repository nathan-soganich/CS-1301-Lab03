...
with col1:
    ...
    Store your keys in Streamlit secrets or environment variables.
    """)
...
with col2:
    ...
    2. **Start** with the Weather Analysis page
    3. **Explore** AI-powered insights
    4. **Chat** with the Weather Assistant
    
    Each page includes intuitive controls and helpful tooltips.
    """)
...
# ==============================================================================
with st.expander("📦 Deployment Instructions (Click to Expand)"):
    st.markdown("""
    ...
    2. **Deploy on Streamlit Cloud:**
       ...
       - Select branch and main file (Home_Page.py)
...
with st.expander("🔧 Technical Implementation Details"):
    ...
    ├── pages/
    │   ├── 1_📊_Weather_Analysis.py
    │   ├── 2_🤖_AI_Weather_Insights.py
    │   └── 3_💬_Weather_Chatbot.py
...
<div style="text-align: center; padding: 2rem 0; color: #666;">
    <p>Built with ❤️ using Streamlit | CS 1301 Fall 2025</p>
...
# ==============================================================================
with st.sidebar:
    st.markdown("### 🌤️ Weather Intelligence Hub")
    st.markdown("---")
    ...
    st.markdown("---")
    st.markdown("### 📊 Lab 03 Requirements")
    st.success("✅ Phase 1: Multi-page setup")
    st.success("✅ Phase 2: API Analysis")
    st.success("✅ Phase 3: LLM Processing")
    st.success("✅ Phase 4: Chatbot")
    st.success("✅ Extra Credit: Layouts")
